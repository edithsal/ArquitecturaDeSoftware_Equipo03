...
//                while (true) {
//                    for (ObjectOutputStream cliente : clientes) {
//                        // No necesitamos leer de los streams de salida, 
//                        // pero sí asegurarnos de tener los sockets actualizados.
//                    }
//                    // En este servidor, la escucha real se hace en manejarCliente(),
//                    // donde ya se reciben objetos y se reenvían.
//                    // Lo que hacemos es registrar los callbacks de mensaje ahí.
//                }
//            } catch (Exception e) {
